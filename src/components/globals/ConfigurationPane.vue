  ...
  methods: {
    ...
    openPane() {
      var content = document.getElementById(
        "ConfigurationContentPane:" + this.$props.name
      );
      if (!this.open) {
        content.classList.add("pane-open");
        content.classList.remove("pane-closed");
        document
          .getElementsByClassName("open-config-button")[0]
...
.open-config-button {
  ...
  -webkit-animation: rotateConfigButtonBack 0.5s ease-in-out 0s 1 normal
    forwards;
...
@-moz-keyframes rotateConfigButton {
  100% {
    transform: rotate(180deg);
  }
}
@-webkit-keyframes rotateConfigButton {
  100% {
    transform: rotate(180deg);
  }
}
@keyframes rotateConfigButton {
  100% {
    transform: rotate(180deg);
  }
}

@-moz-keyframes rotateConfigButtonBack {
  100% {
    transform: rotate(0deg);
  }
}
@-webkit-keyframes rotateConfigButtonBack {
  100% {
    transform: rotate(0deg);
  }
}
@keyframes rotateConfigButtonBack {
  100% {
    transform: rotate(0deg);
  }
}
