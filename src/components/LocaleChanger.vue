<template>
    ...
    <!-- <select v-on:change="onChange" v-model="i18n.global.locale">
        <optgroup>
    ...
    <button v-on:click="showSelect" id="OpenLocaleDropdownButton" class="locale-option-button">
        <i class="bi bi-translate"></i>
        <i :class="'bi ' + (open ? 'bi-caret-down-fill' : 'bi-caret-left-fill')"></i>
    </button>
    <div class="locale-select" v-if="open === true">
        <button v-on:click="select('en')" id="en" :class="'locale-option ' + (i18n.global.locale === 'en' ? 'active': '')">
            <p>English</p>
            <!-- <img src="../assets/flags/us.png">
            <img src="../assets/flags/gb.png">
            <img src="../assets/flags/au.png"> -->
        </button>
        <button v-on:click="select('de')" id="de" :class="'locale-option ' + (i18n.global.locale === 'de' ? 'active': '')">
            <p>Deutsch</p>
            <!-- <img src="../assets/flags/de.png">
            <img src="../assets/flags/at.png">
            <img src="../assets/flags/ch.png"> -->
        </button>
    </div>
  </div>
</template>
    ...
    methods: {
        ...
        select(lang, locale) {
            ...
            for (let i = 0; i < options.length; i++) {
                ...
                console.log(options[i], options[i].id);
