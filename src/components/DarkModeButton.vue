<template>
  <button class="dark-mode-button" v-if="notOnMobile === true" v-on:click="onClick">
...
@-moz-keyframes light { 100% { margin-left: 0; } }
@-webkit-keyframes light { 100% { margin-left: 0; } }
@keyframes light { 100% { margin-left: 0; } }
